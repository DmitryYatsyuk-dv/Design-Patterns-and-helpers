...
let account = Account(accountName: "Dmitry", balance: 1000)
let transactionManager = TransactionManager.shared
transactionManager.addTransactions(command: Deposite(account: account, amount: 555))
transactionManager.addTransactions(command: Withdraw(account: account, amount: 111))
